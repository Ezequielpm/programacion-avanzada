 ...
 * @author ezequ
 */
public class ProfesorAlta extends javax.swing.JFrame {
...
//        if (!objValidador.validaCadena(jTextField1.getText())) return;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProfesorAlta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProfesorAlta().setVisible(true);
            }
        });
    }
